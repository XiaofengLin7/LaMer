...
EXPERIMENT_NAME="gem-multi-task-gigpo-${CONFIG_NAME}-${MODEL_NAME}-disable-thinking-${DISABLE_THINKING}-enable-reflection-${ENABLE_REFLECTION}-reflection-type-${reflection_type}-${FLYTE_INTERNAL_EXECUTION_ID}"
